...
static void ggml_vec_dot_turbo4322_pca_f32(int n, float * GGML_RESTRICT s, size_t bs,
                                           const void * GGML_RESTRICT vx, size_t bx,
                                           const void * GGML_RESTRICT vy, size_t by, int nrc);
static void ggml_vec_dot_turbo4211_pca_f32(int n, float * GGML_RESTRICT s, size_t bs,
                                           const void * GGML_RESTRICT vx, size_t bx,
                                           const void * GGML_RESTRICT vy, size_t by, int nrc);
...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TURBO4211_PCA_0] = {
        ...
        .vec_dot                  = (ggml_vec_dot_t) ggml_vec_dot_turbo4211_pca_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
};
...
static void ggml_vec_dot_turbo4211_pca_f32(int n, float * GGML_RESTRICT s, size_t bs,
    ...
    float tmp[4096];
    GGML_ASSERT(n <= 4096);
    ggml_get_type_traits(GGML_TYPE_TURBO4211_PCA_0)->to_float(vx, tmp, n);
